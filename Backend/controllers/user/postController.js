...
export const likeandDislikePost = async (req, res, next) => {
  try {
    ...
    console.log("🔹 req.params.postId:", req.params.postId); // Check postId
    ...
    console.error("❌ Error in likeandDislikePost:", error);
...
export const addComment = async (req, res, next) => {
  try {
    console.log("🔹 req.user:", req.user);  // Log user details for debugging
    ...
    const newComment = new commentModel({
      text,
      userId: user._id, // This was causing the error
      postId,
    });
